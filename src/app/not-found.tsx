...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-bg-dark pb-24 flex flex-col">
      <TopBar />
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 text-center mt-[-4rem]">
        ...
        <h2 className="text-3xl font-display font-bold text-elite-white mt-4 mb-2">Lost in the sauce?</h2>
