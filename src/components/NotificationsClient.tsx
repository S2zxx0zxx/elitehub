  ...
  return (
    <main className="min-h-screen bg-bg-dark pb-24">
      ...
      <div className="max-w-md mx-auto p-4">
        <h1 className="font-display font-bold text-2xl mb-6 text-elite-white">Alerts</h1>
            ...
            <button 
              ...
              className={`px-4 py-1.5 rounded-full text-sm font-bold transition-colors ${
                filter === f 
                  ...
                  : "bg-surface-dark border border-white/10 text-elite-white"
              }`}
            >
              {f}
            </button>
        ...
        <div className="space-y-4">
          {filteredAlerts.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <h3 className="font-bold text-lg mb-1 text-elite-white">No alerts yet</h3>
